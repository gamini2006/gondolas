...
Fade: <input type="text" id="fade" spellcheck="false" readonly="readonly" value="<?php echo $fade ?>">
Delay: <input type="text" id="delay" spellcheck="false" readonly="readonly" value="<?php echo $delay ?>">
Overlay: <input type="text" id="overlay" spellcheck="false" readonly="readonly" value="<?php echo $overlay ?>">
...
Title: <input type="text" id="link_title" spellcheck="false" value="<?php echo $link_title ?>">
Link: <input type="text" id="link" spellcheck="false" value="<?php echo $link ?>">
Slogan: <input type="text" id="slogan" spellcheck="false" value="<?php echo $slogan ?>">
Slogan Link: <input type="text" id="slogan_link" spellcheck="false" value="<?php echo $slogan_link ?>">
Link Color: <input type="text" id="link_color" spellcheck="false" value="<?php echo $link_color ?>">
Slogan Link Color: <input type="text" id="slogan_link_color" spellcheck="false" value="<?php echo $slogan_link_color ?>">
